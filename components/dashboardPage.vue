        ...
        <div class="card-deck p-5">
            <div class="d-flex flex-fill">
                ...
                <div class="card cardstyle" style="width: 18rem;" to="./viewPlan">
                    <a href="./viewPlan.vue" style="color:white"><img class="card-img" src="../assets/nature.jpg" alt="Card image cap"> </a><!-- Photo by Elvi Madushanka: https://www.pexels.com/photo/view-of-the-galboda-waterfall-in-sri-lanka-12496768/ -->
                    <div class="card-body">
