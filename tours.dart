...
class Tours extends StatefulWidget {
  ...
  HashSet selectItems;
  Tours(this.valueD, this.valueT, this.valueP, this.selectActivity, this.selectItems, this.startDate, this.endDate ,{Key? key}) : super(key: key);

//Tours({Key? key}) : super(key: key);
  @override
  _ToursState createState() => _ToursState(valueD,valueT, valueP,selectActivity,selectItems,startDate,endDate);
}
...
class _ToursState extends State<Tours> {
  ...
  HashSet selectActivity; 
  HashSet selectItems;
  _ToursState(this.valueD,this.valueT,this.valueP,this.selectActivity, this.selectItems, this.startDate, this.endDate);
                                  ...
                                  children:[
                                    Row(
                                       children: [
                                          ...
                                          alignment: Alignment.topLeft,
                                            ...
                                            Container(
                                              ...
                                              child: IconTheme(
                                                ...
                                                child: StarDisplay(value: _allTours[index]['rating'].round()),
                                              ),
                                            ),
                                            Expanded(
                                          child: Container(
                                          padding: new EdgeInsets.all(5.0),
                                          alignment: Alignment.topRight,
                                            child: Text(_allTours[index]['rating'].toString(), style: GoogleFonts.openSans(
                                                        fontSize: 14.0,
                                        ...
                                        child:Container(
                                              ...
                                              decoration: BoxDecoration(
                                                ...
                                                image: DecorationImage(
                                                  fit: BoxFit.fill,
                                                  image: AssetImage('images/' + _allTours[index]['img']),
                                                ),
                                              ),
                                            ),),
                                        ...
                                        child: Container(
                                          child: ListTile(
                                                  title: Padding(
                                                    ...
                                                    padding: const EdgeInsets.only(top:10,bottom: 10.0,left:20,right:5),
                                          child: Text('LKR ${formatter.format(_allTours[index]['price']).toString() }' , style: GoogleFonts.openSans(
                                                        fontSize: 14.0,
                                                        fontWeight: FontWeight.w700,
                                                        color: Color.fromARGB(255, 8, 8, 8)),
